export const TRAITS = [
  {
    ...
    description: "Consistently delivering cutting-edge solutions.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description: "Uniquely addressing complex challenges with human ingenuity.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    ...
    description:
      "Transforming AI breakthroughs into tangible opportunities for innovation and growth.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    title: "Multidisciplinary Problem Solver",
    description:
      "From intricate technical challenges to complex business objectives.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    ...
    description: "To navigate and resolve messy real-world challenges.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    title: "Bridge Technical and Domain Expertise",
    description:
      "Bridging Technical Expertise With Profound Domain Knowledge ... For comprehensive problem-solving.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    title: "Navigate Complex Learning",
    description: "To rapidly acquire new skills and insights.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    ...
    description:
      "Immediately acquiring necessary knowledge to drive project momentum.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    title: "Self-Sufficient Problem-Solver",
    description:
      "Ready to dive deep and independently architect solutions from inception.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    title: "Actively Expanding Expertise In Google Cloud",
    description:
      "From Generative AI fundamentals to advanced application development.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    title: "Specializing In Agent Logic Development",
    description:
      "Leveraging robust platforms for seamless infrastructure, CI/CD, observability, and security.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    title: "Ensuring Rapid, Reliable Application Deployment",
    description: "Through robust CI/CD pipelines.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
...
//   },
//   {
//     title: "Innovative & Collaborative",
...
//         strokeLinejoin="round"
//       >
//         <path d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6"></path>
//       </svg>
//     ),
//   },
//   {
...
//         strokeLinejoin="round"
//       >
//         <path d="M15 11.25l-3-3m0 0l-3 3m3-3v7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
//       </svg>
//     ),
//   },
// ];
