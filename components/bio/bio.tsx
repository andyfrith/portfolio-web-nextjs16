...
export default function Bio() {
  return (
    ...
    >
      ...
      <section>
        <p className="pt-10">
          It is my belief that by growing people, investing in their potential,
          and giving them the space to excel, a team can achieve many great
          things.
        </p>
        <p className="pt-5">
        ...
        <p className="pt-5">
          ...
          performing teams are guided by a vision; only by working together are
          they successful in delivering trusted, highest-quality solutions built
          upon a sound and proven architecture.
        </p>
        <p className="pt-5">
          ...
          enthusiasm and passion for leading product innovation success grows by
          the day. I am currenly applying for both leadership and individual
          contributor roles:
        </p>
        ...
        <p className="pt-5">
          I’d love to learn how I might best impact your team or project. Please
          feel free to reach out to me:
        </p>
        <ul className="list-inside pt-2 underline dark:text-gray-300">
          <li>
